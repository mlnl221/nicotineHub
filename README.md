...
> Stage `d395cc6` — almost 1:1, mobile-friendly. Desktop-only bits are intentionally omitted. See `docs/settings-mapping.md` for the authoritative settings map and `docs/settings-plan.md` for done vs next.
