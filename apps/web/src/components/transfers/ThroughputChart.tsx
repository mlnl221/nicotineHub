  ...
  return (
    <section className="bg-surface dark:bg-surface-container-low rounded-2xl relative overflow-hidden h-56 md:h-64 flex flex-col ghost-border border border-outline-variant/10">
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-between p-5 md:p-6 pointer-events-none">
        <div className="pointer-events-auto w-fit max-w-full rounded-xl bg-surface/85 dark:bg-surface-container-lowest/85 backdrop-blur-md shadow-sm ghost-border px-3 py-2.5 md:px-4 md:py-3">
