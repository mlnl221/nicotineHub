    ...
    <div>
      ...
      <div className="mt-2 flex gap-2">
        {(Object.keys(PERM_KEY) as Perm[]).map((p) => (
          <button
            ...
            type="button"
            onClick={() => setPerm(p)}
            className={`min-h-11 md:min-h-10 flex-1 rounded-xl font-label text-xs font-bold uppercase tracking-widest ${
        ...
        <button
          type="button"
          onClick={add}
          className="min-h-11 md:min-h-10 shrink-0 rounded-xl bg-secondary-container px-4 font-label text-xs font-bold uppercase tracking-widest text-on-secondary-container"
        >
          Add
        </button>
      </div>
      ...
      <div className="mt-3 flex items-center gap-2">
        <button
          ...
          className="inline-flex min-h-11 md:min-h-10 items-center gap-1.5 rounded-xl bg-surface-container-high px-4 font-label text-xs font-bold uppercase tracking-widest text-primary disabled:opacity-50 dark:bg-surface-container-highest/60"
        >
