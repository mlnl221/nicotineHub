    ...
    <div className="glass-panel rounded-2xl p-4">
      ...
      <div className="mb-3 flex gap-2">
        <input
          ...
          className="flex-1 rounded-xl bg-surface-container-low px-3 py-2.5 min-h-11 md:min-h-10 text-base text-on-surface outline-none focus:ring-1 focus:ring-primary dark:bg-surface-container-high md:text-sm"
        />
        <button onClick={handleAdd} className="rounded-xl bg-primary px-4 py-2.5 min-h-11 md:min-h-10 text-sm font-medium text-on-primary">Add</button>
      </div>
