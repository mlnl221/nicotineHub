...
export function Sidebar() {
  ...
  return (
    <nav className="fixed left-0 top-0 z-50 flex h-full w-72 flex-col space-y-8 bg-surface-container-low/90 p-6 backdrop-blur-md dark:bg-surface-container-low/90">
      <div>
