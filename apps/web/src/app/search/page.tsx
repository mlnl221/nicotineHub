  ...
  return (
    <RequireAuth>
      <div className="flex min-h-screen max-w-full overflow-x-clip bg-surface-container-low dark:bg-inverse-surface">
        ...
        <main className="md:ml-72 flex min-h-screen flex-1 flex-col bg-surface-container-low dark:bg-inverse-surface pt-[calc(60px+env(safe-area-inset-top,0px))] md:pt-0 pb-[calc(64px+env(safe-area-inset-bottom,0px))] md:pb-0 max-w-full overflow-x-clip min-w-0">
          <SearchScreen />
        </main>
        <BottomNav />
      </div>
