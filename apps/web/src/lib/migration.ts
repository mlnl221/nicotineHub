...
const LOCAL_STORAGE_KEYS: Array<[string, string]> = [
  ...
  ["nicotine.browse.asideW", "nicotineHub.browse.asideW"],
  ["nicotine.chat.asideW", "nicotineHub.chat.asideW"],
  ["nicotine.privatechat.asideW", "nicotineHub.privatechat.asideW"],
