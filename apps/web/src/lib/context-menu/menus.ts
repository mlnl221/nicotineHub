...
export function transferMenu(t: { user: string; fileName: string; path?: string; virtualPath?: string }, isUpload: boolean, acts: { onResume?: () => void; onPause?: () => void; onRemove: () => void; onRetry?: () => void; onClear?: () => void; onAnalyzeSpectrum?: () => void; hasSpectrum?: boolean; onEditTags?: () => void }): MenuItem[] {
