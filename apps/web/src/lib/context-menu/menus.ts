...
export function fileExplorerMenu(entry: { path: string; name: string }, opts: { onEditTags?: () => void; onScrape?: () => void; onVerify?: () => void; onAnalyze?: () => void; onSpectrum?: () => void; hasSpectrum?: boolean; isAudio?: boolean; onPlay?: () => void }): MenuItem[] {
